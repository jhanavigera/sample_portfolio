...
class Zone(dns.transaction.TransactionManager):
    ...
    def to_file(self, f, sorted=True, relativize=True, nl=None, want_comments=False):
    ...
    def to_text(self, sorted=True, relativize=True, nl=None, want_comments=False):
...
class Transaction(dns.transaction.Transaction):
    ...
    _deleted_rdataset = dns.rdataset.Rdataset(dns.rdataclass.ANY, dns.rdatatype.ANY)
    ...
    def _end_transaction(self, commit):
        if commit and self._changed():
            for (name, rdtype, covers), rdataset in self.rdatasets.items():
                if rdataset is self._deleted_rdataset:
