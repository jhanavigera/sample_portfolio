...
def setup_filters():
    ...
    for msg in [
        ...
        r"The legacy calling style of select\(\) is deprecated and will be " "removed",
        ...
        "SQLAlchemy 2.0.",
        r"The (?:insert|update).values parameter will be removed in " "SQLAlchemy 2.0.",
        ...
        r"Using strings to indicate column or relationship paths in " "loader options",
        r"Using strings to indicate relationship names in the ORM " r"with_parent\(\)",
        ...
        r".*object is being merged into a Session along the backref " "cascade path",
        r"Passing bind arguments to Session.execute\(\) as keyword arguments",
        r"The merge_result\(\) method is superseded by the " r"merge_frozen_result\(\)",
